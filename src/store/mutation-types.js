...
/* archive */
export const GET_ARCHIVE_TOP = 'GET_ARCHIVE_TOP'
export const GET_ARCHIVE_MARKET = 'GET_ARCHIVE_MARKET'
export const GET_ARCHIVE_KNOWLEDGE = 'GET_ARCHIVE_KNOWLEDGE'

/* search */
export const GET_SEARCH_HOT = 'GET_SEARCH_HOT'
export const GET_SEARCH_EXPAND = 'GET_SEARCH_EXPAND'
export const GET_SEARCH_CORRECTED = 'GET_SEARCH_CORRECTED'
export const GET_SEARCH_USER = 'GET_SEARCH_USER'
export const GET_SEARCH_QUESTION = 'GET_SEARCH_QUESTION'
